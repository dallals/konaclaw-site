...
- `make shots` — regenerate screenshots into `src/assets/shots/` from the demo profile (needs the KonaClaw code repo at `$KC_REPO`, default `~/Desktop/claudeCode/SammyClaw`). Never commit a screenshot taken any other way.
